...
fn lookup(key: &'static str, is_en: bool) -> &'static str {
    match (key, is_en) {
        ...
        ("act_click", false) => "Mausklick",
        ("act_click", true) => "Mouse Click",
        ...
        // Click Types & Coordinates
        ("click_type_label", false) => "Klick-Aktion:",
        ("click_type_label", true) => "Click Action:",
        ("click_left", false) => "Linksklick",
        ("click_left", true) => "Left Click",
        ("click_right", false) => "Rechtsklick",
        ("click_right", true) => "Right Click",
        ("click_double", false) => "Doppelklick",
        ("click_double", true) => "Double Click",
        ("coords_mode_label", false) => "Positionierung:",
        ("coords_mode_label", true) => "Positioning:",
        ("coords_cursor", false) => "Aktuelle Mausposition",
        ("coords_cursor", true) => "Current cursor position",
        ("coords_fixed", false) => "Feste Koordinaten (X, Y)",
        ("coords_fixed", true) => "Fixed coordinates (X, Y)",
        ("pick_coords_btn", false) => "Position erfassen (F6)",
        ("pick_coords_btn", true) => "Pick Coordinates (F6)",
        ("coords_x_label", false) => "X-Koordinate (px):",
        ("coords_x_label", true) => "X Coordinate (px):",
        ("coords_y_label", false) => "Y-Koordinate (px):",
        ("coords_y_label", true) => "Y Coordinate (px):",
        ("center_window_btn", false) => "Fenstermitte übernehmen",
        ("center_window_btn", true) => "Use Window Center",
        ("repeat_label", false) => "Wiederholen:",
        ("repeat_label", true) => "Repeat:",
        ("iteration_label", false) => "Durchlauf",
        ("iteration_label", true) => "Iteration",
        ("infinite_label", false) => "Endlos",
        ("infinite_label", true) => "Infinite",
